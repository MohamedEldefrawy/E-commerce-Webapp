        ...
        <a href="" class="text-decoration-none">
            <h1 class="m-0 display-5 font-weight-semi-bold text-primary">
                <img style="max-height: 100px; max-width: 100px;margin-left: 10px" class="image img-circle mr-auto"
                     src="<c:url value="/resources/static/images/logo/logo_dark.png"/>">
        ...
        <form:form modelAttribute="customerDTO" class="form-horizontal" method="post">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <form:input type="text" class="form-control" id="inputUserName" placeholder="User Name"
                                    path="userName"/>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <form:input type="email" class="form-control" name="userEmail" id="inputEmail3"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <form:input maxlength="30" minlength="8" type="password" class="form-control"
