...
class OrderServiceTest {
    ...
    void create_NullOrder_returnException(){
        ...
        Order entity =null;
        //Act
        when(orderRepositoryMock.save(entity)).thenThrow(new NullOrderException("Null Order Provided"));
        //Assert
...
//        //Act
//        when(orderRepositoryMock.save(entity)).thenReturn(Optional.empty());
//        //Assert
