...
<div class="container-fluid">
    <div class="row align-items-center py-3 px-xl-5">
        <div class="col-lg-3 d-none d-lg-block">
            <a href="" class="text-decoration-none">
                <h1 class="m-0 display-5 font-weight-semi-bold custom-text-primary">
        ...
        <div class="col-lg-6 col-6 text-left">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button id="btnSearch" class="input-group-text bg-transparent custom-text-primary">
    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn shadow-none d-flex align-items-center justify-content-between custom-bg-primary text-white w-100"
